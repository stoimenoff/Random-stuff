...
void newSort(int c[],int bid){
    for(int i =0 ; i<8;i++)
	{


		if(c[i]/100==bid||bid==6){
        if(c[i]%100 == 9 )
            c[i]+=19 ;
        if(c[i]%100 == 10)
            c[i]+= 10 ;
...
void announce(int p1[],int p2[],int p3[],int p4[],int score[],int bid){
    ...
    cout<<"team 1 highest :"<<team1highest<<endl;
    cout<<"team 2 highest :"<<team2highest<<endl;
    cout<<"p1 anno :"<<p1anno<<endl;
    cout<<"p2 anno :"<<p2anno<<endl;
    cout<<"p3 anno :"<<p3anno<<endl;
    cout<<"p4 anno :"<<p4anno<<endl;
    team1highest=0;team2highest=0;cntr1=0;cntr2=0;int cntr3=0,cntr4=0;p1anno=0,p2anno=0, p3anno=0, p4anno=0;
    newSort(p1,bid);newSort(p2,bid);newSort(p3,bid);newSort(p4,bid);
...
void playTheGame(int playerOne[],int playerTwo[],int playerThree[],int playerFour[],int realScore[],int plOnTheGo ,int bid){
        int cardsOnBoard[4];
        for(int i=0;i<4;i++)
        cardsOnBoard[i]=0;
...
int main(){
    ...
    while(realScore[0]<151&&realScore[1]<151){
        ...
        newSort(playerOne,bid);
        newSort(playerThree,bid);
        newSort(playerFour,bid);
        newSort(playerTwo,bid);
        ...
        playTheGame(playerOne,playerTwo,playerThree,playerFour,realScore, plOnTheGo, bid);
        plOnTheGo++;
