...
const int deck = 32;
char deckStyle=178;
int pos1=0,pos2=0,pos3=0,pos4=0,bid=0,redouble=0,anno[2]={0,0},hang=0,passNumber=0;
...
void playerBid(int p[],int whoAmI,int p1[]){
    ...
    if(playerbid<7&&((whoAmI!=bid/10)||bid==0)){bid=(whoAmI*10)+playerbid;passNumber=0;}
    Sleep(1200);
    if(playerbid==7){
        passNumber++;
