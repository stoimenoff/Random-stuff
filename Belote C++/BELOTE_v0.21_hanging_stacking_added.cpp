...
void playTheGame(int playerOne[],int playerTwo[],int playerThree[],int playerFour[],int realScore[],int plOnTheGo ){
        ...
        if(score[bidderTeam]<score[nonbidderTeam]){
                ...
                score[nonbidderTeam]+=hang;
                hang=0;
                wasThereHanging=0;
        }
        if(score[bidderTeam]>score[nonbidderTeam]){
            score[bidderTeam]+=hang;
            hang=0;
            wasThereHanging=0;
        }
        ...
        if(bid%10<5)
        {
            ...
            if(hang%10<6&&wasThereHanging==1)hang=hang/10;
            else hang=(hang/10)+1;
        }
        if(bid%10==5)
        {
        ...
        if(bid%10==6)
        {
            ...
            if(hang%10<4&&wasThereHanging==1)hang=hang/10;
            else hang=(hang/10)+1;
        }
        score[0]=0;score[1]=0;
}
