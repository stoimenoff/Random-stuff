...
void playTheGame(int playerOne[],int playerTwo[],int playerThree[],int playerFour[]/*int realScore[] */){
        int cardsOnBoard[4];
        for(int i=0;i<4;i++)
        cardsOnBoard[i]=0;
...
//    while(realScore[0]<151&&realScore[1]<151){
        ...
        cout<<endl;
        playTheGame(playerOne,playerTwo,playerThree,playerFour/*,realScore*/);
