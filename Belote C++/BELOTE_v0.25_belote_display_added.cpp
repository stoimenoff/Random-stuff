...
for(int i=0;i<8;i++)
    ...
    for(int i=0;i<8;i++)
        if(p1[i]%100==(carre%100)+600)p1[i]-=600;
        newSort(p1);
    return anno;
}
...
void announce(int p1[],int p2[],int p3[],int p4[],int score[],int bid){
    ...
    for(int i=0;i<8;i++)
        {
            if(p1[i]%100==(carre1%100)+600) p1[i]-=600;
            if(p2[i]%100==(carre2%100)+600) p2[i]-=600;
            if(p3[i]%100==(carre3%100)+600) p3[i]-=600;
            if(p4[i]%100==(carre4%100)+600) p4[i]-=600;
        }
    team1highest++;
    team2highest++;
    if(team1highest>team2highest)
